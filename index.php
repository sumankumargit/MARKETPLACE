...
<body>
    ...
    <h2 style="text-align:center;" class="m-5">RECENT JOBS</h2>
    ...
    <table id="jobs_table" class="table table-striped table-bordered">
        ...
        <tbody>
        <?php
        //SHOWING ONLY THOSE BIDS WHERE THE JOB IS STILL OPEN and expiration date is not passed
        
        $query = 'SELECT * FROM jobs WHERE status="open" and expiration > NOW() ORDER BY id DESC LIMIT 10';
       ...
       <?php }
        ...
        <a class="btn btn-success" href="active.php">ACTIVE JOBS</a>
